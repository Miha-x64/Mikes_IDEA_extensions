...
class PathCmdTest {
    ...
    fun reconstruct2() {
        ...
        val reconstruction = StringBuilder()
        cmds1.appendTo(reconstruction, 1)
    ...
    @Test fun recognizesML() {
        ...
        assert(StringBuilder().also { cmds.appendTo(it, Int.MAX_VALUE) }.toString() == "M0 0 5 5 4 4")

        cmds.clear()
        PathDelegate.parse("M0 0L5 5 0 0", pathsBlackHole, cmds, null, IntArrayList(), null, false)
        assert(StringBuilder().also { cmds.appendTo(it, Int.MAX_VALUE) }.toString() == "M0 0L5 5 0 0")
        checkBlackHoles()
    }
    ...
    @Test fun autoChains() {
        ...
        assert(StringBuilder().also { cmds.appendTo(it, Int.MAX_VALUE) }.toString() == "M0 0-1-1.5.5.5")
    }
